"""Tests for test investigations web.
اختبارات المشروع التي تثبت contracts وحدود الطبقات وسلوك workflow الظاهر في أسماء الاختبارات وimports.

الموقع في المعمارية: Test suite.
يُستدعى بواسطة: pytest أو أدوات acceptance.
يعتمد مباشرة على: app.interfaces.admin.web.routes.
...
def test_investigations_page_is_available():
    ...
    تُستدعى عندما يصل المسار إلى test_investigations_page_is_available؛ المدخلات المهمة: لا توجد مدخلات موضعية مهمة.
...
def test_investigation_detail_page_is_available():
    ...
    تُستدعى عندما يصل المسار إلى test_investigation_detail_page_is_available؛ المدخلات المهمة: لا توجد مدخلات موضعية مهمة.
    تعيد نتيجة العملية الحالية أو تسجل/ترجع الأثر الذي يحدده هذا الـworkflow. يفشل الاختبار عند خرق الـcontract.
    """

...
from app.composition.investigation.final_diagnosis_narrative_client_factory import (
...
from app.infrastructure.ssh.remediation.service_state_evidence_collector import SSHServiceStateEvidenceCollector
from app.infrastructure.ssh.remediation.named_write_runner import SSHNamedWriteRunner
from app.infrastructure.ssh.remediation.service_verifier import SSHServiceVerifier
...
from app.infrastructure.ssh.investigation.ssh_diagnostic_command_runner import SSHDiagnosticCommandRunner
...
def build_core_services(
    ...
    evidence_collection_service = EvidenceCollectionService(
        ...
        runner=SSHDiagnosticCommandRunner(),
    )
    ...
    final_diagnosis_client = None
    if settings.llm_enabled:
        final_diagnosis_client = create_final_diagnosis_narrative_client(
            settings
        )
